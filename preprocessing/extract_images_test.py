...
bottom_up_attention_dir = os.path.join( script_dir , 'bottom-up-attention')
sys.path.insert(0, os.path.join( bottom_up_attention_dir + '/caffe/python/'))
sys.path.insert(0, os.path.join( bottom_up_attention_dir + '/lib/'))
sys.path.insert(0, os.path.join( bottom_up_attention_dir + '/tools/'))
...
data_path = bottom_up_attention_dir + '/data/genome/1600-400-20'
print (bottom_up_attention_dir)
print ( data_path)
...
data_dir = bottom_up_attention_dir + '/../../data/test'
data_classes = ['test']
...
for ite, subclass in enumerate(data_classes):
    for iname in sorted(os.listdir(os.path.join(data_dir, subclass))):
        ...
        for i in range(len(keep_boxes)):
            ...
            # print "cls is %s\n" %cls
            imCrop = im[int(bbox[1]):int(bbox[1]+bbox[3]),
